package com.aad888.util.feifei;

public class Hello {
    //图片识别

    /**
     * "/Users/fushiyong/gitRepos/zidong888aad/src/main/java/com/aad888/util/feifei/1570010035107.png";
     * @param imagePath
     * @return
     * @throws Exception
     */
    public static String recognize(String imagePath) throws Exception {
        System.out.println(("准备识别图片验证码,文件地址:" + imagePath));
        Api api = new Api();
        String app_id = "318616";
        String app_key = "G6vhCHBo06jYX7esllS/FNsyzPJR1LMj";
        String pd_id = "118616";
        String pd_key = "4gjVSJ1z+4/OBwO48gooyKWjOqvhZzBA";
        ...
        System.out.println("图片打码平台余额:" + balance+"积分");
        
        // 具体类型可以查看官方网站的价格页选择具体的类型，不清楚类型的，可以咨询客服
        String pred_type = "30400";
        // 通过文件进行验证码识别,请使用自己的图片文件替换
        String img_file = imagePath;
